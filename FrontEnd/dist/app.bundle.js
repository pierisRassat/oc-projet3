...
/***/ "./src/addWork/addWorkBackModalListener.js":
/*!*************************************************!*\
  !*** ./src/addWork/addWorkBackModalListener.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ addWorkBackModalListener)\n/* harmony export */ });\nfunction addWorkBackModalListener (backBtn) {\n  backBtn.addEventListener('click', (event) => {\n    const addWorkModal = document.querySelector('.add-work-modal')\n    if (typeof (addWorkModal) !== 'undefined' && addWorkModal !== null) {\n      addWorkModal.remove()\n      const modal = document.querySelector('.modal')\n      modal.style.display = 'flex'\n    }\n  })\n}\n\n\n//# sourceURL=webpack://frontend/./src/addWork/addWorkBackModalListener.js?");

/***/ }),

/***/ "./src/addWork/addWorkCloseModalListener.js":
/*!**************************************************!*\
  !*** ./src/addWork/addWorkCloseModalListener.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ addWorkCloseModalListener)\n/* harmony export */ });\nfunction addWorkCloseModalListener (closeBtn) {\n  closeBtn.addEventListener('click', (event) => {\n    const addWorkModal = document.querySelector('.add-work-modal')\n    if (typeof (addWorkModal) !== 'undefined' && addWorkModal !== null) {\n      addWorkModal.remove()\n    }\n    const modal = document.querySelector('.modal')\n    if (typeof (modal) !== 'undefined' && modal !== null) {\n      modal.remove()\n    }\n  })\n}\n\n\n//# sourceURL=webpack://frontend/./src/addWork/addWorkCloseModalListener.js?");

/***/ }),

/***/ "./src/addWork/addWorkWindowCloseModalListener.js":
/*!********************************************************!*\
  !*** ./src/addWork/addWorkWindowCloseModalListener.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ addWorkWindowCloseModalListener)\n/* harmony export */ });\nfunction addWorkWindowCloseModalListener () {\n  const addWorkModal = document.querySelector('.add-work-modal')\n\n  addWorkModal.addEventListener('click', (event) => {\n    if (event.target === addWorkModal) {\n      addWorkModal.remove()\n    }\n  })\n}\n\n\n//# sourceURL=webpack://frontend/./src/addWork/addWorkWindowCloseModalListener.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ deleteWork)\n/* harmony export */ });\n/* harmony import */ var _works_portfolio_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../works/portfolio.js */ \"./src/works/portfolio.js\");\n/* harmony import */ var _modalEditMode_createModal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modalEditMode/createModal.js */ \"./src/modalEditMode/createModal.js\");\n\n\n\nasync function deleteWork (listenerNumber) {\n  const endpointUrl = `http://localhost:5678/api/works/${listenerNumber}`\n\n  try {\n    const tokenStr = window.sessionStorage.getItem('token')\n    await fetch(endpointUrl, {\n      method: 'DELETE',\n      headers: {\n        Authorization: `Bearer ${tokenStr}`,\n        'Content-Type': 'application/json'\n      }\n    })\n    const modal = document.querySelector('.modal')\n    if (typeof (modal) !== 'undefined' || modal !== null) {\n      modal.remove()\n      ;(0,_modalEditMode_createModal_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])()\n      ;(0,_works_portfolio_js__WEBPACK_IMPORTED_MODULE_0__.displayPortfolio)()\n    }\n  } catch (error) {\n    console.error(error)\n  }\n}\n\n\n//# sourceURL=webpack://frontend/./src/deleteWork/requestDeleteWork.js?");
...
/***/ "./src/modalEditMode/addCloseModalListener.js":
/*!****************************************************!*\
  !*** ./src/modalEditMode/addCloseModalListener.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ addCloseModalListener)\n/* harmony export */ });\nfunction addCloseModalListener (closeBtn) {\n  closeBtn.addEventListener('click', (event) => {\n    const modal = document.querySelector('.modal')\n    if (typeof (modal) !== 'undefined' && modal !== null) {\n      modal.remove()\n    }\n  })\n}\n\n\n//# sourceURL=webpack://frontend/./src/modalEditMode/addCloseModalListener.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ addEditListener)\n/* harmony export */ });\n/* harmony import */ var _createModal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createModal.js */ \"./src/modalEditMode/createModal.js\");\n\n\nfunction addEditListener () {\n  const editButton = document.querySelector('.edit-projects-btn button')\n  const modal = document.querySelector('.modal')\n\n  editButton.addEventListener('click', (event) => {\n    if (typeof (modal) !== 'undefined' || modal !== null) {\n      (0,_createModal_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])()\n    }\n  })\n}\n\n\n//# sourceURL=webpack://frontend/./src/modalEditMode/addEditListener.js?");

/***/ }),

/***/ "./src/modalEditMode/addWindowCloseModalListener.js":
/*!**********************************************************!*\
  !*** ./src/modalEditMode/addWindowCloseModalListener.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ addWindowCloseModalListener)\n/* harmony export */ });\nfunction addWindowCloseModalListener () {\n  const modal = document.querySelector('.modal')\n\n  modal.addEventListener('click', (event) => {\n    if (event.target === modal) {\n      modal.remove()\n    }\n  })\n}\n\n\n//# sourceURL=webpack://frontend/./src/modalEditMode/addWindowCloseModalListener.js?");
